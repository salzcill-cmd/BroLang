...
def _load_module(name: str) -> None:
    ...
    # v6.2 modules (dijanjikan docs/STDLIB.md)
        ...
        from brolang.stdlib.web_server import module as web_server_module

        register_module("web_server", web_server_module)
    # v6.4 modules
    elif name == "kripto":
        from brolang.stdlib.kripto import module as kripto_module

        register_module("kripto", kripto_module)
    elif name == "arsip":
        from brolang.stdlib.arsip import module as arsip_module

        register_module("arsip", arsip_module)
    elif name == "terminal":
